...
// Function to toggle the game pause
void togglePause() {
...
/*Изменения и пояснения:
    Функция паузы:
        Функция togglePause() ожидает в цикле, пока снова не будет нажата клавиша 'P', чтобы возобновить игру. 
        Это эффективно замораживает игру, не выходя из основного цикла.
        Когда игра приостановлена, на экран выводится сообщение, а затем очищается экран, чтобы сохранить 
        чистый интерфейс игры.
    Инструкция по паузе:
        Добавлена в нижнюю часть игрового экрана, чтобы информировать игрока о том, как приостановить и возобновить игру.
    Главный цикл:
        Теперь правильно проверяет нажатие клавиши 'P' для приостановки/возобновления игры, не влияя на состояние игры.
Тестирование и отладка:
Запустить программу и нажать 'P' во время игры, чтобы убедиться, что игра правильно приостанавливается и возобновляется. 
Если возникнут какие-либо проблемы, проверить соответствующие разделы кода, чтобы убедиться, что обработка 
ввода с клавиатуры и управление паузой/возобновлением работают как положено.
*/
